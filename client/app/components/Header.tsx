const Header = () => {
    return ( 
        <div className="bgdiamonds bg-zinc-900 flex flex-row gap-5 text-zinc-400 px-14 pt-7 pb-5 sm:justify-start justify-center fixed w-full border-b border-b-zinc-800 z-10">
