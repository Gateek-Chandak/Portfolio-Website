const Header = () => {
    return ( 
        <div className="flex flex-row gap-5 text-zinc-400 px-14 pt-7 pb-5 ml-auto fixed bg-zinc-900 w-full border-b border-b-zinc-800 z-10">
             <a href="#home">
            ...
            <a href="#skills">
                <h1 className="transition ease-in-out duration-300 hover:text-gradient-middle hover:underline">Skills</h1>
            </a>
            <a href="#resume">
