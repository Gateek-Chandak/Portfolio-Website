    ...
    return ( 
        <div className="min-h-fit flex flex-col items-center w-full pt-24 pb-20 snap-start scroll-container " id="projects">
            ...
            <div className="w-10/12 mt-10 grid grid-cols-1 md:grid-cols-2 gap-10 z-0 h-fit">
                <Card className="border bg-zinc-800 bgdiamonds transform transition duration-500 hover:scale-110 z-10 border-blue-900 hover:border-gradient-right h-fit" as={Link} href="https://github.com/Gateek-Chandak/Study-Bot">
                    <CardHeader>
                ...
                <Card className="border bg-zinc-800 bgdiamonds transform transition duration-500 hover:scale-110 z-10 border-green-900 hover:border-green-300 h-fit" as={Link} href="https://github.com/Gateek-Chandak/Estate-Eagle">
                    <CardHeader>
                ...
                <Card className="border bg-zinc-800 bgdiamonds transform transition duration-500 hover:scale-110 z-10 border-purple-900 hover:border-purple-500 h-fit" as={Link} href="https://workout-wizard-five.vercel.app">
                    <CardHeader>
                ...
                <Card className="border bg-zinc-800 bgdiamonds transform transition duration-500 hover:scale-110 z-10 border-amber-900 hover:border-amber-500 h-fit" as={Link} href="https://github.com/Gateek-Chandak/Arena_Warrior">
                    <CardHeader>
