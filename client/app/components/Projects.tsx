    ...
    return ( 
        <div className="min-h-screen flex flex-col items-center w-full pt-24 pb-12 snap-start scroll-container" id="projects">
            ...
            <div className="w-11/12 mt-10 grid grid-cols-3 gap-6 z-0 h-dvh">
                ...
                <Card className="border border-zinc-800 bg-zinc-500 transform transition duration-500 hover:scale-105 hover:border-zinc-500" as={Link} href='https://github.com/Gateek-Chandak/Colour_Switch_Remake'>
                    <CardHeader>
