...
const HeroPage = () => {
    return ( 
        <div className="flex min-h-dvh max-h-fit flex-col items-center w-full snap-start scroll-container bgdiamonds" id="home">
            <Header />
            <h1 className="text-center px-5 mt-36 sm:text-5xl text-4xl text-zinc-200">Gateek Chandak</h1>
            <ChangingText /> 
            <div className="px-5 text-center flex flex-col items-center gap-4 w-9/12 text-zinc-300 text-lg">
                ...
                <Link href="https://github.com/Gateek-Chandak" target="_blank" className="text-zinc-600 transition ease-in-out duration-300 hover:text-orange-400">
                ...
                <p className="text-zinc-400 text-sm">contact me : g2chanda@uwaterloo.ca or 647-642-0609</p>
            </div>
        </div>
     );
}
