...
const HeroPage = () => {
    return ( 
        <div className="flex min-h-screen flex-col items-center w-full snap-start scroll-container" id="home">
            <Header />
            ...
            <div className="px-40 flex flex-col items-center gap-4 w-9/12 text-zinc-300 text-lg">
                ...
                <p className="">
                    <span className="">Studying </span><span className="font-bold text-gradient-middle">Computer Science</span> and <span className="font-bold text-gradient-middle">Finance</span> @ <span className="font-bold">University of Waterloo</span>.
                </p>
                <p>
                <span className="font-extrabold">Developing</span> software to help the UW student community @ <span className="font-bold text-gradient-middle">UW Code Labs</span>
                </p>
